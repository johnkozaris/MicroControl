...
public class MicroModule {
    ...
    private ControlType ParseStrToControlType(String ctype) {
        switch (ctype) {
            case IConstants.ControlTypes.ANALOG_DISPLAY:
                return ControlType.ANALOG_DISPLAY;
            case IConstants.ControlTypes.DIGITAL_DISPLAY:
                return ControlType.DIGITAL_DISPLAY;
            case IConstants.ControlTypes.MOTOR_CONRTOL:
                return ControlType.MOTOR_CONRTOL;
            case IConstants.ControlTypes.LCD_TEXT:
                return ControlType.LCD_TEXT;
            case IConstants.ControlTypes.SWITCH:
